...
#SBATCH --nodelist=dgx4
#SBATCH --partition=batch
#SBATCH --gres=gpu:1         # Specify the partition
...
for SCENE in "${SCENES[@]}"; do
  ...
  # python get_3d_features.py -s /home/runyi_yang/benchmark2025/dataset/ScanNetpp/data/$SCENE --model_path /home/runyi_yang/benchmark2025/dataset/ScanNetpp/data/$SCENE/gsplat/ --dataformat scannetpp --runon_train
done